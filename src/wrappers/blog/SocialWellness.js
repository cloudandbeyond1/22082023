        ...
        <div className="row align-items-center justify-content-center">
          <div className="col-md-8 col-lg-6 order-2 order-lg-1">
            <div className="funfact-content funfact-res text-left" >
              ...
              <h3 className="ml-10">Social Wellness</h3>
              </div>
              <p className="pt-4 w-75">
                Social wellness encompasses a variety of healthy behaviors including adequate exercise, proper nutrition and abstaining from harmful habits such as drug use and alcohol abuse.
